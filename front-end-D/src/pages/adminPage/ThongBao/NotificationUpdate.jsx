...
const NotificationUpdate = () => {
        ...
        await fetch(`/api/admin/thongbao/${id}`,{
            ...
            async(res)=>{
                ...
                if (resData.error){
                    ...
                    setGetDataNotification(resData.getThongBao)
                }
            }
        )
    }
    ...
    for (let i=0;i<getDataNotification.nhanvien.length;i++){
        dataEmployeeNotification.push({
            value: getDataNotification.nhanvien[i].id,
            label: getDataNotification.nhanvien[i].HoTen
        })
    }
    let dataEmployee = []
    ...
    const initialValues = {
        title: getDataNotification.TieuDe,
        content: getDataNotification.NoiDung,
