...
const BonusGroupUpdate = () => {
  ...
  const [getDataBonusGroup, setDataBonusGroup] = useState(null);
  const getBonusGroup = async () => {
    await fetch(`/api/admin/khenthuongtapthe/${id}`, {
      method: 'GET',
      headers: {
        "Authorization": `Bearer ${token}`
      }
      ...
      async (res) => {
        ...
        if (resData.error) {
          ...
          setDataBonusGroup(resData.getKhenThuong)
        }
      })
  }
  useEffect(() => {
  ...
  const initialValueBonusGroup = {
    MaKT: getDataBonusGroup.MaKT,
    CanCu: getDataBonusGroup.CanCu,
    LyDo: getDataBonusGroup.LyDo,
    HinhThuc: getDataBonusGroup.HinhThuc,
    SoQD: getDataBonusGroup.SoQD,
    NgayQD: getDataBonusGroup.NgayQD,
    NguoiBanHanh: getDataBonusGroup.NguoiBanHanh,
    Thang: getDataBonusGroup.Thang,
    TienThuong: getDataBonusGroup.TienThuong,
    idDoiTuong: getDataBonusGroup.PhongBan ? getDataBonusGroup.PhongBan.id : '',
    NgayKT: getDataBonusGroup.NgayKT,
    NguonChi: getDataBonusGroup.NguonChi,
    TrangThai: getDataBonusGroup.TrangThai
  }
  const handleReturn = async () => {
    navigate(`/admin/bonus`)
}
const handleSubmitGroup= async(values)=>{
  await fetch(`/api/admin/khenthuongtapthe/${id}/update`, {
    method: 'PUT',
    headers: {
...
export default BonusGroupUpdate
