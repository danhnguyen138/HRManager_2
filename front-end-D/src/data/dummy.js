...
import { BsKanban, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft, BsBuilding, BsGift, BsHousesFill } from 'react-icons/bs';
import { BiColorFill, BiUser, BiTimeFive, BiMoney } from 'react-icons/bi';
...
import { MdAssignment, MdCurrencyExchange } from 'react-icons/md';
import { IoMdContacts, IoMdNotifications } from 'react-icons/io';
import {FaMoneyBill, FaMoneyBillTransfer} from 'react-icons/fa';
...
export const dataThue = [
  {
    id: 1,
    name: 'Tiền giảm trừ gia cảnh bản thân',
    value: 11000000,
    SoQD: 'Công văn 9188/CTHN-HKDCN năm 2022'
  },
  {
    id: 2,
    name: 'Tiền giảm trừ gia cảnh người phụ thuộc',
    value: 4400000,
    SoQD: 'Công văn 9188/CTHN-HKDCN năm 2022'
  },
  {
    id: 3,
    name: 'Thuế suất',
    SoQD: 'Điều 22 Luật thuế thu nhập cá nhân 2007',
    data: [{
      id: 1,
      start: 0,
      end: 5000000,
...
export const links_admin = [
  {
    ...
    links: [{
      ...
      name:'Quy định lương tối thiểu',
      to:'/admin/law',
      icon: <VscLaw />
    },{
      name:'Thang bậc lương',
      to:'/admin/wage',
      icon: <FaMoneyBill />
    }]
  },
